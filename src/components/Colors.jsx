...
function Colors() {
    ...
    const [selectedColor, setSelectedColor] = useState('blue'); // ✅ corrigido
        ...
        <section id="colors" className="bg-black py-20 px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex justify-center items-center gap-4">
                    {colors.map(color => (
                        <button
                            key={color.id} onClick={() => setSelectedColor(color.id)}
                ...
                <div className="text-center mt-16">
                    <button className="bg-blue-700 hover:bg-blue-800 text-white px-12 py-4 rounded-full text-lg font-semibold transition-all duration-300 mb-8 hover:scale-105 shadow-md shadow-blue-500/50 cursor-pointer">
                        Compre agora à partir de <span className="font-bold text-gray-100">R$ 9.950,00</span>
                    </button>
                    <p className="text-gray-400 text-sm mt-2">
                        Ou em até <span className="font-medium text-white">12x de R$ 994,95</span> sem juros
                    </p>
                </div>
